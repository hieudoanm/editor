(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [332],
  {
    2283: (e, t, n) => {
      ...
      n.d(t, { c: () => s });
      var l = n(5640);
      let s = () => (0, l.jsx)('div', { className: 'w-full border-t border-neutral-800' });
    },
    3602: (e, t, n) => {
            ...
            children: (0, l.jsxs)('div', {
              ...
              children: [
                (0, l.jsx)('div', {
                  ...
                  children: (0, l.jsx)(a(), { href: '/', children: s.C3 }),
                }),
                (0, l.jsx)('div', {
                  className: 'hidden space-x-4 md:flex',
                  children: i.map((e) => {
                    let { id: t, href: n, label: s } = e;
                    return (0, l.jsx)(a(), { href: n, className: 'hover:underline', children: s }, t);
                  }),
                }),
              ],
            }),
    ...
    7298: (e, t, n) => {
      ...
      let s = {
        Button: (e) => {
          let { type: t = 'button', children: n, className: s = '', disabled: r, ...a } = e;
      ...
      var r = n(9064),
        a = n.n(r);
      let i = (e) => {
          let { title: t = '', subtitle: n = '', action: r = '' } = e;
          return (0, l.jsxs)('section', {
            className: 'flex flex-col items-center justify-center px-6 py-20',
            children: [
              (0, l.jsx)('h2', { className: 'mb-4 text-center text-2xl font-semibold md:text-3xl', children: t }),
              (0, l.jsx)('p', { className: 'mb-6 text-center text-neutral-300', children: n }),
              (0, l.jsx)('div', {
                className: 'flex w-full items-center justify-center',
                children: (0, l.jsx)(a(), { href: '/csv', children: (0, l.jsx)(s.Button, { children: r }) }),
              }),
            ],
          });
        },
        c = (e) => {
          ...
          return (0, l.jsx)('section', {
            ...
            children: (0, l.jsx)('div', {
              className: 'container mx-auto grid grid-cols-1 gap-8 text-center md:grid-cols-3',
              children: t.map((e, t) => {
                ...
                return (0, l.jsxs)(
                  ...
                  {
                    children: [
                      (0, l.jsx)('h3', { className: 'text-xl font-semibold', children: n }),
                      (0, l.jsx)('p', { className: 'mt-2 text-neutral-400', children: r }),
                    ],
                  },
                  t,
                );
      ...
      let d = () =>
          (0, l.jsx)('footer', {
            ...
            children: (0, l.jsxs)('div', {
              ...
              children: [
                (0, l.jsxs)('p', {
                  children: ['\xa9 ', new Date().getFullYear(), ' ', o.C3, '. All rights reserved.'],
                }),
                (0, l.jsx)('div', {
                  className: 'space-x-4',
                  children: (0, l.jsx)(a(), {
        ...
        h = (e) => {
          let { headline: t = '', tagline: n = '', action: r = '' } = e;
          return (0, l.jsxs)('header', {
            className: 'flex flex-col items-center justify-center px-6 py-20 text-center',
            children: [
              (0, l.jsx)('h1', {
                className: 'mb-4 text-4xl font-extrabold md:text-5xl',
                children: (0, l.jsx)(x.Text, { children: t }),
              }),
              (0, l.jsx)('p', { className: 'mb-8 max-w-xl text-neutral-100', children: n }),
              (0, l.jsx)(a(), {
                href: '/csv',
                className: 'w-full md:w-auto',
                children: (0, l.jsx)(s.Button, { children: r }),
              }),
            ],
          });
        };
      ...
      let f = {
        ...
        j = () =>
          (0, l.jsxs)('div', {
            className: 'min-h-screen w-full bg-neutral-900 text-neutral-100',
            children: [
              (0, l.jsx)(x.Background, {}),
              (0, l.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, l.jsx)(u.c, {}),
                  (0, l.jsx)(h, {
                    headline: f.landing.hero.headline,
                    tagline: f.landing.hero.tagline,
                    action: f.landing.hero.action,
                  }),
                  (0, l.jsx)(u.c, {}),
                  (0, l.jsx)(c, { features: f.landing.features }),
                  (0, l.jsx)(u.c, {}),
                  (0, l.jsx)(i, {
                    title: f.landing.callToAction.title,
                    subtitle: f.landing.callToAction.subtitle,
                    action: f.landing.callToAction.action,
                  }),
                  (0, l.jsx)(u.c, {}),
                  (0, l.jsx)(d, {}),
                ],
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    (e.O(0, [64, 636, 593, 792], () => t(3602)), (_N_E = e.O()));
  },
]);
