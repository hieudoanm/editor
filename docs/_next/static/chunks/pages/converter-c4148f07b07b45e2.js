      ...
      let i = 'yaml',
        c = () => {
          let [
            {
              data: e = l.wY,
              from: t = (0, o.Pq)(l.wY).format().beautify(),
              to: r = (0, o.Pq)(l.wY).convert(i),
              format: c = i,
            },
            u,
          ] = (0, s.useState)({
                    ...
                    (0, n.jsxs)('div', {
                      ...
                      children: [
                        (0, n.jsx)('button', {
                          ...
                          onClick: () => {
                            let t = (0, o.Pq)(e).format().beautify();
                            u((e) => ({ ...e, from: t }));
                          },
                          children: 'Beautify',
                        }),
          ...
          switch ($) {
            case n.JSTOXML_OBJECT: {
              ...
              if (Array.isArray(o) && o.every(m))
                return o.map((e) => x({ _name: a, _content: e }, { ...t, depth: r, _isOutputStart: !1 })).join('');
              if (l.includes(a)) break;
              let c = x(o, { ...t, depth: r + 1, _isOutputStart: J }),
                u = s(c),
                f = p(c),
                y = i(c),
                h = `${k}${E}`;
...
${E}`,
            ...
            case n.OBJECT: {
              ...
              L = r
                .map((a, o) => {
                  let i = { ...t, _isFirstItem: 0 === o, _isLastItem: o + 1 === r.length, _isOutputStart: J },
                    c = { _name: a };
                  if (
                    s(e[a]) === n.OBJECT &&
                    (l.forEach((t) => {
            ...
            case n.ARRAY:
              L = e
                .map((r, n) =>
                  x(r, { ...t, _isFirstItem: 0 === n, _isLastItem: n + 1 === e.length, _isOutputStart: J }),
                )
                .join('');
              break;
            default:
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    (e.O(0, [864, 0, 636, 593, 792], () => t(9083)), (_N_E = e.O()));
  },
]);
