  ...
  [0],
  {
    9e3: (e, t, s) => {
      ...
      let i = Symbol.for('yaml.alias'),
        ...
        u = Symbol.for('yaml.node.type'),
        h = (e) => !!e && 'object' == typeof e && e[u] === i,
        f = (e) => !!e && 'object' == typeof e && e[u] === r,
        d = (e) => !!e && 'object' == typeof e && e[u] === o,
        p = (e) => !!e && 'object' == typeof e && e[u] === l,
        m = (e) => !!e && 'object' == typeof e && e[u] === a,
        y = (e) => !!e && 'object' == typeof e && e[u] === c;
      function g(e) {
      ...
      function E(e, t) {
        let s = I(t);
        f(e)
          ? N(null, e.contents, s, Object.freeze([e])) === S && (e.contents = null)
          : N(null, e, s, Object.freeze([]));
      }
      function N(e, t, s, n) {
        let i = T(e, t, s, n);
        if (b(i) || p(i)) return (x(e, n, i), N(e, i, s, n));
        if ('symbol' != typeof i) {
          if (g(t)) {
            n = Object.freeze(n.concat(t));
            for (let e = 0; e < t.items.length; ++e) {
              let i = N(e, t.items[e], s, n);
              if ('number' == typeof i) e = i - 1;
              else {
                if (i === w) return w;
                i === S && (t.items.splice(e, 1), (e -= 1));
              }
            }
          } else if (p(t)) {
            n = Object.freeze(n.concat(t));
            let e = N('key', t.key, s, n);
            if (e === w) return w;
            e === S && (t.key = null);
            let i = N('value', t.value, s, n);
            if (i === w) return w;
            i === S && (t.value = null);
          }
        }
      ...
      async function O(e, t) {
        let s = I(t);
        f(e)
          ? (await A(null, e.contents, s, Object.freeze([e]))) === S && (e.contents = null)
          : await A(null, e, s, Object.freeze([]));
      }
      async function A(e, t, s, n) {
        let i = await T(e, t, s, n);
        if (b(i) || p(i)) return (x(e, n, i), A(e, i, s, n));
        if ('symbol' != typeof i) {
          if (g(t)) {
            n = Object.freeze(n.concat(t));
            for (let e = 0; e < t.items.length; ++e) {
              let i = await A(e, t.items[e], s, n);
              if ('number' == typeof i) e = i - 1;
              else {
                if (i === w) return w;
                i === S && (t.items.splice(e, 1), (e -= 1));
            ...
            n = Object.freeze(n.concat(t));
            let e = await A('key', t.key, s, n);
            if (e === w) return w;
            e === S && (t.key = null);
            let i = await A('value', t.value, s, n);
            if (i === w) return w;
            i === S && (t.value = null);
          }
        }
      ...
      function x(e, t, s) {
        let n = t[t.length - 1];
        if (g(n)) n.items[e] = s;
        else if (p(n)) 'key' === e ? (n.key = s) : (n.value = s);
        else if (f(n)) n.contents = s;
        else {
          let e = h(n) ? 'alias' : 'scalar';
          throw Error(`Cannot replace node with ${e} parent`);
        }
      }
      ((E.BREAK = w), (E.SKIP = v), (E.REMOVE = S), (O.BREAK = w), (O.SKIP = v), (O.REMOVE = S));
      let $ = { '!': '%21', ',': '%2C', '[': '%5B', ']': '%5D', '{': '%7B', '}': '%7D' },
        L = (e) => e.replace(/[!,[\]{}]/g, (e) => $[e]);
      class C {
        constructor(e, t) {
          ((this.docStart = null),
        ...
        add(e, t) {
          ...
          switch (n) {
            case '%TAG': {
              if (2 !== s.length && (t(0, '%TAG directive should contain exactly two parts'), s.length < 2)) return !1;
              let [e, n] = s;
        ...
        tagName(e, t) {
          ...
          if ('<' === e[1]) {
            ...
            return '!' === s || '!!' === s
              ...
              : ('>' !== e[e.length - 1] && t('Verbatim tags must end with a >'), s);
          }
          let [, s, n] = e.match(/^(.*!)([^!]*)$/s);
        ...
        tagString(e) {
          for (let [t, s] of Object.entries(this.tags)) if (e.startsWith(s)) return t + L(e.substring(s.length));
          return '!' === e[0] ? e : `!<${e}>`;
        }
        toString(e) {
          let t,
            s = this.yaml.explicit ? [`%YAML ${this.yaml.version || '1.2'}`] : [],
      ...
      function j(e, t, s) {
        if (Array.isArray(e)) return e.map((e, t) => j(e, String(t), s));
        if (e && 'function' == typeof e.toJSON) {
          if (!s || !k(e)) return e.toJSON(t, s);
      ...
      class D {
        ...
        toJS(e, { mapAsMap: t, maxAliasCount: s, onAnchor: n, reviver: i } = {}) {
          if (!f(e)) throw TypeError('A document argument is required');
          let r = {
              anchors: new Map(),
              doc: e,
              keep: !0,
            ...
            o = j(this, '', r);
          if ('function' == typeof n) for (let { count: e, res: t } of r.anchors.values()) n(t, e);
      ...
      class P extends D {
        ...
        toJSON(e, t) {
          ...
          let { anchors: s, doc: n, maxAliasCount: i } = t,
            r = this.resolve(n, t);
          if (!r) throw ReferenceError(`Unresolved alias (the anchor must be set before the alias): ${this.source}`);
          let o = s.get(r);
          if ((o || (j(r, null, t), (o = s.get(r))), !o || void 0 === o.res))
          ...
          if (
            ...
            0 === o.aliasCount &&
              (o.aliasCount = (function e(t, s, n) {
                ...
                return p(s) ? Math.max(e(t, s.key, n), e(t, s.value, n)) : 1;
              })(n, r, s)),
        ...
        toString(e, t, s) {
          let n = `*${this.source}`;
          if (e) {
            if ((_(this.source), e.options.verifyAliasOrder && !e.anchors.has(this.source)))
      ...
      let q = (e) => !e || ('function' != typeof e && 'object' != typeof e);
      class U extends D {
        constructor(e) {
      ...
      function R(e, t, s) {
        let n;
        if ((f(e) && (e = e.contents), b(e))) return e;
        if (p(e)) {
          let t = s.schema[o].createNode?.(s.schema, null, s);
        ...
        (e instanceof String ||
          ...
          (e = e.valueOf());
        let { aliasDuplicateObjects: i, onAnchor: r, onTagObj: l, schema: a, sourceObjects: u } = s;
        if (i && e && 'object' == typeof e) {
          if ((n = u.get(e))) return (n.anchor ?? (n.anchor = r(e)), new P(n.anchor));
          ((n = { anchor: null, node: null }), u.set(e, n));
        }
        ...
        if (!h) {
          ...
          h = e instanceof Map ? a[o] : Symbol.iterator in Object(e) ? a[c] : a[o];
        }
        l && (l(h), delete s.onTagObj);
        let d = h?.createNode
          ? h.createNode(s.schema, e, s)
          : 'function' == typeof h?.nodeClass?.from
            ? h.nodeClass.from(s.schema, e, s)
            : new U(e);
        return (t ? (d.tag = t) : h.default || (d.tag = h.tag), n && (n.node = d), d);
      }
      function F(e, t, s) {
        let n = s;
      ...
      let V = (e) => null == e || ('object' == typeof e && !!e[Symbol.iterator]().next().done);
      class J extends D {
        constructor(e, t) {
          (super(e),
        ...
        clone(e) {
          ...
          return (
            e && (t.schema = e),
            (t.items = t.items.map((t) => (b(t) || p(t) ? t.clone(e) : t))),
        ...
        addIn(e, t) {
          if (V(e)) this.add(t);
            ...
            else throw Error(`Expected YAML collection at ${s}. Remaining path: ${n}`);
          }
        }
        deleteIn(e) {
          let [t, ...s] = e;
          ...
          let n = this.get(t, !0);
          if (g(n)) return n.deleteIn(s);
          throw Error(`Expected YAML collection at ${t}. Remaining path: ${s}`);
        }
        getIn(e, t) {
          let [s, ...n] = e,
            i = this.get(s, !0);
          return 0 === n.length ? (!t && m(i) ? i.value : i) : g(i) ? i.getIn(n, t) : void 0;
        }
        hasAllNullValues(e) {
          return this.items.every((t) => {
            if (!p(t)) return !1;
            let s = t.value;
            return null == s || (e && m(s) && null == s.value && !s.commentBefore && !s.comment && !s.tag);
          });
        }
        hasIn(e) {
          let [t, ...s] = e;
      ...
      function z(
        ...
        t,
        s = 'flow',
        { indentAtStart: n, lineWidth: i = 80, minContentWidth: r = 20, onFold: o, onOverflow: l } = {},
      ) {
        let a, c, u;
        if (!i || i < 0) return e;
        i < r && (r = 0);
        let h = Math.max(1 + r, 1 + i - t.length);
        if (e.length <= h) return e;
        let f = [],
          d = {},
          p = i - t.length;
        'number' == typeof n && (n > i - Math.max(2, r) ? f.push(0) : (p = i - n));
        let m = !1,
          y = -1,
          g = -1,
          b = -1;
        for (s === Q && -1 !== (y = Z(e, y, t.length)) && (p = y + h); (u = e[(y += 1)]); ) {
          if (s === X && '\\' === u) {
            switch (((g = y), e[y + 1])) {
              case 'x':
                y += 3;
          ...
          if ('\n' === u) (s === Q && (y = Z(e, y, t.length)), (p = y + t.length + h), (a = void 0));
          else {
            if (' ' === u && c && ' ' !== c && '\n' !== c && '	' !== c) {
              let t = e[y + 1];
              t && ' ' !== t && '\n' !== t && '	' !== t && (a = y);
            ...
            if (y >= p)
              if (a) (f.push(a), (p = a + h), (a = void 0));
              else if (s === X) {
                for (; ' ' === c || '	' === c; ) ((c = u), (u = e[(y += 1)]), (m = !0));
                let t = y > b + 1 ? y - 2 : g - 1;
                if (d[t]) return e;
                (f.push(t), (d[t] = !0), (p = t + h), (a = void 0));
              } else m = !0;
          }
          c = u;
        }
        if ((m && l && l(), 0 === f.length)) return e;
        o && o();
        let k = e.slice(0, f[0]);
            ...
            switch (s[e + 1]) {
              case 'u':
                {
                  ...
                  switch (t) {
                    ...
                    case '2029':
                      ...
                      break;
                    default:
                      '00' === t.substr(0, 2) ? (o += '\\x' + t.substr(2)) : (o += s.substr(e, 6));
                  }
                  ((e += 5), (l = e + 1));
                }
                break;
              case 'n':
                if (n || '"' === s[e + 2] || s.length < i) e += 1;
                  ...
                  for (o += s.slice(l, e) + '\n\n'; '\\' === s[e + 2] && 'n' === s[e + 3] && '"' !== s[e + 4]; )
                    ((o += '\n'), (e += 2));
                  ((o += r), ' ' === s[e + 2] && (o += '\\'), (e += 1), (l = e + 1));
                }
                break;
              default:
                e += 1;
            }
        return ((o = l ? o + s.slice(l) : s), n ? o : z(o, r, X, ee(t, !1)));
      }
      function en(e, t) {
...
${s}`,
            ...
            "'";
        return t.implicitKey ? n : z(n, s, H, ee(t, !1));
      }
      function ei(e, t) {
        let s,
          { singleQuote: n } = t.options;
        if (!1 === n) s = es;
        else {
          let t = e.includes('"'),
            i = e.includes("'");
          s = t && !i ? en : i && !t ? es : n ? en : es;
        }
        return s(e, t);
      }
      try {
      ...
      function er({ comment: e, type: t, value: s }, i, r, o) {
        let l,
          a,
          c,
          { blockQuote: u, commentString: h, lineWidth: f } = i.options;
        if (!u || /\n[\t ]+$/.test(s) || /^\s*$/.test(s)) return ei(s, i);
        let d = i.indent || (i.forceBlockIndent || et(s) ? '  ' : ''),
          p =
            'literal' === u ||
            ('folded' !== u &&
              t !== U.BLOCK_FOLDED &&
        ...
        let m = s.substring(a),
          y = m.indexOf('\n');
        (-1 === y ? (l = '-') : s === m || y !== m.length - 1 ? ((l = '+'), o && o()) : (l = ''),
          m &&
...
${d}${k}${s}${m}`
      ...
      function eo(e, t, s, n) {
        let { implicitKey: i, inFlow: r } = t,
          ...
          { type: l } = e;
        l !== U.QUOTE_DOUBLE && /[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value) && (l = U.QUOTE_DOUBLE);
        let a = (e) => {
            switch (e) {
              case U.BLOCK_FOLDED:
              case U.BLOCK_LITERAL:
                return i || r ? ei(o.value, t) : er(o, t, s, n);
              case U.QUOTE_DOUBLE:
                return es(o.value, t);
              case U.QUOTE_SINGLE:
                return en(o.value, t);
              case U.PLAIN:
                return (function (e, t, s, n) {
                  let { type: i, value: r } = e,
                    { actualString: o, implicitKey: l, indent: a, indentStep: c, inFlow: u } = t;
                  if ((l && r.includes('\n')) || (u && /[[\]{},]/.test(r))) return ei(r, t);
                  if (/^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(r))
                    return l || u || !r.includes('\n') ? ei(r, t) : er(e, t, s, n);
                  if (!l && !u && i !== U.PLAIN && r.includes('\n')) return er(e, t, s, n);
                  if (et(r)) {
                    if ('' === a) return ((t.forceBlockIndent = !0), er(e, t, s, n));
                    else if (l && a === c) return ei(r, t);
                  }
                  let h = r.replace(
                    /\n+/g,
                    `$&
${a}`,
                  ...
                  if (o) {
                    let e = (e) => e.default && 'tag:yaml.org,2002:str' !== e.tag && e.test?.test(h),
                      { compat: s, tags: n } = t.doc.schema;
                    if (n.some(e) || s?.some(e)) return ei(r, t);
                  }
                  return l ? h : z(h, a, H, ee(t, !1));
                })(o, t, s, n);
              default:
                return null;
            }
        ...
        if (null === c) {
          let { defaultKeyType: e, defaultStringType: s } = t.options,
            n = (i && e) || s;
          if (null === (c = a(n))) throw Error(`Unsupported default string type ${n}`);
        }
        return c;
      }
      function el(e, t) {
      ...
      function ea(e, t, s, n) {
        let i;
        if (p(e)) return e.toString(t, s, n);
        if (h(e)) {
        ...
        let r = b(e) ? e : t.doc.createNode(e, { onTagObj: (e) => (i = e) });
        i ??
          (i = (function (e, t) {
            let s, n;
            if (t.tag) {
              let s = e.filter((e) => e.tag === t.tag);
              if (s.length > 0) return s.find((e) => e.format === t.format) ?? s[0];
            }
            if (m(t)) {
              s = t.value;
            ...
            if (!n) {
              let e = s?.constructor?.name ?? (null === s ? 'null' : typeof s);
        ...
        let o = (function (e, t, { anchors: s, doc: n }) {
          ...
          let i = [],
            r = (m(e) || g(e)) && e.anchor;
          r && _(r) && (s.add(r), i.push(`&${r}`));
          let o = e.tag ?? (t.default ? null : t.tag);
          return (o && i.push(n.directives.tagString(o)), i.join(' '));
        })(r, i, t);
        o.length > 0 && (t.indentAtStart = (t.indentAtStart ?? 0) + o.length + 1);
        let l =
          'function' == typeof i.stringify ? i.stringify(r, t, s, n) : m(r) ? eo(r, t, s, n) : r.toString(t, s, n);
        return o
          ? m(r) || '{' === l[0] || '[' === l[0]
            ? `${o} ${l}`
            : `${o}
${t.indent}${l}`
      ...
      let eu = {
          ...
          test: /^<<$/,
          resolve: () => Object.assign(new U(Symbol('<<')), { addToJSMap: ef }),
          stringify: () => '<<',
        },
        eh = (e, t) =>
          (eu.identify(t) || (m(t) && (!t.type || t.type === U.PLAIN) && eu.identify(t.value))) &&
          e?.doc.schema.tags.some((e) => e.tag === eu.tag && e.default);
      function ef(e, t, s) {
        if (y((s = e && h(s) ? s.resolve(e.doc) : s))) for (let n of s.items) ed(e, t, n);
        else if (Array.isArray(s)) for (let n of s) ed(e, t, n);
        else ed(e, t, s);
      }
      function ed(e, t, s) {
        let n = e && h(s) ? s.resolve(e.doc) : s;
        if (!d(n)) throw Error('Merge sources must be maps or map aliases');
        for (let [s, i] of n.toJSON(null, e, Map))
          t instanceof Map
            ? t.has(s) || t.set(s, i)
            : t instanceof Set
              ? t.add(s)
              : Object.prototype.hasOwnProperty.call(t, s) ||
                Object.defineProperty(t, s, { value: i, writable: !0, enumerable: !0, configurable: !0 });
        return t;
      }
      function ep(e, t, { key: s, value: n }) {
        if (b(s) && s.addToJSMap) s.addToJSMap(e, t, n);
        else if (eh(e, s)) ef(e, t, n);
        else {
          let i = j(s, '', e);
          if (t instanceof Map) t.set(i, j(n, i, e));
            ...
            let r = (function (e, t, s) {
                ...
                if (b(e) && s?.doc) {
                  let t = el(s.doc, {});
                  for (let e of ((t.anchors = new Set()), s.anchors.keys())) t.anchors.add(e.anchor);
              ...
              o = j(n, r, e);
            r in t
              ? Object.defineProperty(t, r, { value: o, writable: !0, enumerable: !0, configurable: !0 })
              : (t[r] = o);
          }
        }
        return t;
      ...
      function em(e, t, s) {
        return new ey(R(e, void 0, s), R(t, void 0, s));
      }
      class ey {
        constructor(e, t = null) {
          (Object.defineProperty(this, u, { value: l }), (this.key = e), (this.value = t));
        }
        clone(e) {
          let { key: t, value: s } = this;
          return (b(t) && (t = t.clone(e)), b(s) && (s = s.clone(e)), new ey(t, s));
        }
        toJSON(e, t) {
            ...
            ? (function ({ key: e, value: t }, s, n, i) {
                let r,
                  ...
                  l,
                  {
                    ...
                    indent: u,
                    indentStep: h,
                    options: { commentString: f, indentSeq: d, simpleKeys: p },
                  } = s,
                  k = (b(e) && e.comment) || null;
                if (p) {
                  if (k) throw Error('With simple keys, key nodes cannot have comments');
                  if (g(e) || (!b(e) && 'object' == typeof e))
                ...
                let w =
                  ...
                  (!e ||
                    (k && null == t && !s.inFlow) ||
                    g(e) ||
                    (m(e) ? e.type === U.BLOCK_FOLDED || e.type === U.BLOCK_LITERAL : 'object' == typeof e));
                s = Object.assign({}, s, { allNullValues: !1, implicitKey: !w && (p || !a), indent: u + h });
                let v = !1,
                  S = !1,
                  E = ea(
                    e,
                ...
                if (!w && !s.inFlow && E.length > 1024) {
                  if (p) throw Error('With simple keys, single line scalar must not span more than 1024 characters');
                  w = !0;
                }
                if (s.inFlow) {
                  if (a || null == t) return (v && n && n(), '' === E ? '?' : w ? `? ${E}` : E);
                } else if ((a && !p) || (null == t && w))
                  return ((E = `? ${E}`), k && !v ? (E += W(E, s.indent, f(k))) : S && i && i(), E);
                (v && (k = null),
                  w
                    ? (k && (E += W(E, s.indent, f(k))),
                      (E = `? ${E}
${u}:`))
                    : ((E = `${E}:`), k && (E += W(E, s.indent, f(k)))),
                  b(t)
                    ? ((r = !!t.spaceBefore), (o = t.commentBefore), (l = t.comment))
                    : ((r = !1), (o = null), (l = null), t && 'object' == typeof t && (t = c.createNode(t))),
                  (s.implicitKey = !1),
                  !w && !k && m(t) && (s.indentAtStart = E.length + 1),
                  (S = !1),
                  !(!d && h.length >= 2 && !s.inFlow && !w && y(t)) ||
                    t.flow ||
                    t.tag ||
                    t.anchor ||
...
${s.indent}`)
                  ...
                  if (i || !r) {
                    ...
                    if (i && ('&' === e || '!' === e)) {
                      let s = O.indexOf(' ');
                      ('&' === e && -1 !== s && s < n && '!' === O[s + 1] && (s = O.indexOf(' ', s + 1)),
                        (-1 === s || n < s) && (t = !0));
                    }
                    t ||
                      (A = `
${s.indent}`);
                ...
                return (
                  (E += A + O),
                  s.inFlow ? N && n && n() : l && !N ? (E += W(E, s.indent, f(l))) : S && i && i(),
                  E
                );
              })(this, e, t, s)
            : JSON.stringify(this);
      ...
      function eg(e, t, s) {
        return (
          (t.inFlow ?? e.flow)
            ? function ({ items: e }, t, { flowChars: s, itemIndent: n }) {
                let {
                    indent: i,
                    indentStep: r,
                  ...
                  a = Object.assign({}, t, { indent: (n += r), inFlow: !0, type: null }),
                  c = !1,
                  u = 0,
                  h = [];
                for (let s = 0; s < e.length; ++s) {
                  let i = e[s],
                    r = null;
                  if (b(i)) (i.spaceBefore && h.push(''), eb(t, h, i.commentBefore, !1), i.comment && (r = i.comment));
                  else if (p(i)) {
                    let e = b(i.key) ? i.key : null;
                    e && (e.spaceBefore && h.push(''), eb(t, h, e.commentBefore, !1), e.comment && (c = !0));
                    let s = b(i.value) ? i.value : null;
                    s
                      ? (s.comment && (r = s.comment), s.commentBefore && (c = !0))
                      : null == i.value && e?.comment && (r = e.comment);
                  }
                  r && (c = !0);
                  let o = ea(i, a, () => (r = null));
                  (s < e.length - 1 && (o += ','),
                    r && (o += W(o, n, l(r))),
                    !c && (h.length > u || o.includes('\n')) && (c = !0),
                    h.push(o),
                    (u = h.length));
                }
                let { start: f, end: d } = s;
                if (0 === h.length) return f + d;
                if (!c) {
                  let e = h.reduce((e, t) => e + t.length + 2, 2);
                  c = t.options.lineWidth > 0 && e > t.options.lineWidth;
                }
                if (!c) return `${f}${o}${h.join(' ')}${o}${d}`;
                {
                  let e = f;
                  for (let t of h)
                    e += t
...
${i}${d}`;
            ...
            : function (
                { comment: e, items: t },
                s,
                { blockItemPrefix: n, flowChars: i, itemIndent: r, onChompKeep: o, onComment: l },
              ) {
                let a,
                  {
                    indent: c,
                  ...
                  h = Object.assign({}, s, { indent: r, type: null }),
                  f = !1,
                  d = [];
                for (let e = 0; e < t.length; ++e) {
                  let i = t[e],
                    o = null;
                  if (b(i))
                    (!f && i.spaceBefore && d.push(''), eb(s, d, i.commentBefore, f), i.comment && (o = i.comment));
                  else if (p(i)) {
                    let e = b(i.key) ? i.key : null;
                    e && (!f && e.spaceBefore && d.push(''), eb(s, d, e.commentBefore, f));
                  }
                  f = !1;
                  let l = ea(
                    i,
                  ...
                  (o && (l += W(l, r, u(o))), f && o && (f = !1), d.push(n + l));
                }
...
${c}${t}`
      ...
      function eb({ indent: e, options: { commentString: t } }, s, n, i) {
        if ((n && i && (n = n.replace(/^\n+/, '')), n)) {
          let i = G(t(n), e);
          s.push(i.trimStart());
        }
      ...
      function ek(e, t) {
        let s = m(t) ? t.value : t;
        for (let n of e) if (p(n) && (n.key === t || n.key === s || (m(n.key) && n.key.value === s))) return n;
      }
      class ew extends J {
        static get tagName() {
        ...
        static from(e, t, s) {
          let { keepUndefined: n, replacer: i } = s,
            ...
            o = (e, o) => {
              ...
              (void 0 !== o || n) && r.items.push(em(e, o, s));
            };
        ...
        add(e, t) {
          let s;
          s = p(e) ? e : e && 'object' == typeof e && 'key' in e ? new ey(e.key, e.value) : new ey(e, e?.value);
          let n = ek(this.items, s.key),
            i = this.schema?.sortMapEntries;
          if (n) {
            if (!t) throw Error(`Key ${s.key} already set`);
            m(n.value) && q(s.value) ? (n.value.value = s.value) : (n.value = s.value);
          } else if (i) {
        ...
        delete(e) {
          let t = ek(this.items, e);
          return !!t && this.items.splice(this.items.indexOf(t), 1).length > 0;
        }
        get(e, t) {
          let s = ek(this.items, e),
            n = s?.value;
          return (!t && m(n) ? n.value : n) ?? void 0;
        }
        has(e) {
          return !!ek(this.items, e);
        }
        set(e, t) {
          this.add(new ey(e, t), !0);
        }
        toJSON(e, t, s) {
          let n = s ? new s() : t?.mapAsMap ? new Map() : {};
          for (let e of (t?.onCreate && t.onCreate(n), this.items)) ep(t, n, e);
          return n;
        }
        toString(e, t, s) {
          if (!e) return JSON.stringify(this);
          for (let e of this.items)
            if (!p(e)) throw Error(`Map items must all be pairs; found ${JSON.stringify(e)} instead`);
          return (
      ...
      let ev = {
        ...
        createNode: (e, t, s) => ew.from(e, t, s),
      };
      class eS extends J {
        static get tagName() {
        ...
        set(e, t) {
          let s = eE(e);
          if ('number' != typeof s) throw Error(`Expected a valid index, not ${e}.`);
          let n = this.items[s];
          m(n) && q(t) ? (n.value = t) : (this.items[s] = t);
        }
        toJSON(e, t) {
          let s = [];
          t?.onCreate && t.onCreate(s);
          let n = 0;
          for (let e of this.items) s.push(j(e, String(n++), t));
          return s;
        }
        toString(e, t, s) {
          return e
      ...
      let eN = {
          ...
          resolve: (e, t) => (y(e) || t('Expected a sequence for this tag'), e),
          createNode: (e, t, s) => eS.from(e, t, s),
        },
        eO = {
          ...
          resolve: (e) => e,
          stringify: (e, t, s, n) => eo(e, (t = Object.assign({ actualString: !0 }, t)), s, n),
        },
        eA = {
          identify: (e) => null == e,
          ...
          test: /^(?:~|[Nn]ull|NULL)?$/,
          resolve: () => new U(null),
          stringify: ({ source: e }, t) => ('string' == typeof e && eA.test.test(e) ? e : t.options.nullStr),
        },
        eI = {
          ...
          resolve: (e) => new U('t' === e[0] || 'T' === e[0]),
          stringify: ({ source: e, value: t }, s) =>
            e && eI.test.test(e) && t === ('t' === e[0] || 'T' === e[0])
              ? e
              : t
                ? s.options.trueStr
                : s.options.falseStr,
        };
      function eT({ format: e, minFractionDigits: t, tag: s, value: n }) {
        if ('bigint' == typeof n) return String(n);
        let i = 'number' == typeof n ? n : Number(n);
        if (!isFinite(i)) return isNaN(i) ? '.nan' : i < 0 ? '-.inf' : '.inf';
        let r = JSON.stringify(n);
        if (!e && t && (!s || 'tag:yaml.org,2002:float' === s) && /^\d/.test(r)) {
          let e = r.indexOf('.');
          e < 0 && ((e = r.length), (r += '.'));
      ...
      let ex = {
        ...
        eL = {
          ...
          test: /^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,
          resolve(e) {
            let t = new U(parseFloat(e)),
              s = e.indexOf('.');
            return (-1 !== s && '0' === e[e.length - 1] && (t.minFractionDigits = e.length - s - 1), t);
          },
          stringify: eT,
        },
        eC = (e) => 'bigint' == typeof e || Number.isInteger(e),
        e_ = (e, t, s, { intAsBigInt: n }) => (n ? BigInt(e) : parseInt(e.substring(t), s));
      function eB(e, t, s) {
        let { value: n } = e;
        return eC(n) && n >= 0 ? s + n.toString(t) : eT(e);
      }
      let eK = {
          identify: (e) => eC(e) && e >= 0,
          default: !0,
          ...
          format: 'OCT',
          test: /^0o[0-7]+$/,
          resolve: (e, t, s) => e_(e, 2, 8, s),
          stringify: (e) => eB(e, 8, '0o'),
        },
        eM = {
          identify: eC,
          default: !0,
        ...
        ej = {
          ...
          format: 'HEX',
          test: /^0x[0-9a-fA-F]+$/,
          resolve: (e, t, s) => e_(e, 2, 16, s),
          stringify: (e) => eB(e, 16, '0x'),
        },
        eD = [ev, eN, eO, eA, eI, eK, eM, ej, ex, e$, eL];
      function eP(e) {
        return 'bigint' == typeof e || Number.isInteger(e);
      }
      let eq = ({ value: e }) => JSON.stringify(e),
        eU = [ev, eN].concat(
          [
            {
              identify: (e) => 'string' == typeof e,
            ...
            },
            {
              ...
              stringify: ({ value: e }) => (eP(e) ? e.toString() : JSON.stringify(e)),
            },
            {
              identify: (e) => 'number' == typeof e,
              default: !0,
        ...
        eR = {
          ...
          stringify({ comment: e, type: t, value: s }, n, i, r) {
            ...
            if ((t ?? (t = U.BLOCK_LITERAL), t !== U.QUOTE_DOUBLE)) {
              let e = Math.max(n.options.lineWidth - n.indent.length, n.options.minContentWidth),
                s = Math.ceil(o.length / e),
                i = Array(s);
              for (let t = 0, n = 0; t < s; ++t, n += e) i[t] = o.substr(n, e);
              o = i.join(t === U.BLOCK_LITERAL ? '\n' : ' ');
            }
            return eo({ comment: e, type: t, value: o }, n, i, r);
          },
        };
      function eF(e, t) {
        if (y(e))
          for (let s = 0; s < e.items.length; ++s) {
            ...
            if (!p(n)) {
              if (d(n)) {
                ...
                let e = n.items[0] || new ey(new U(null));
                if (
                  (n.commentBefore &&
...
${t.comment}`
      ...
      function eV(e, t, s) {
        ...
        if (t && Symbol.iterator in Object(t))
          for (let e of t) {
            let o, l;
            if (('function' == typeof n && (e = n.call(t, String(r++), e)), Array.isArray(e)))
            ...
            i.items.push(em(o, l, s));
          }
        return i;
      }
      let eJ = { collection: 'seq', default: !1, tag: 'tag:yaml.org,2002:pairs', resolve: eF, createNode: eV };
      class eY extends eS {
        constructor() {
          (super(),
            (this.add = ew.prototype.add.bind(this)),
            (this.delete = ew.prototype.delete.bind(this)),
            (this.get = ew.prototype.get.bind(this)),
            (this.has = ew.prototype.has.bind(this)),
            (this.set = ew.prototype.set.bind(this)),
            (this.tag = eY.tag));
        }
        toJSON(e, t) {
          ...
          for (let e of (t?.onCreate && t.onCreate(s), this.items)) {
            let n, i;
            if ((p(e) ? ((n = j(e.key, '', t)), (i = j(e.value, n, t))) : (n = j(e, '', t)), s.has(n)))
      ...
      let eG = {
        ...
        resolve(e, t) {
          ...
          for (let { key: e } of s.items)
            m(e) &&
              (n.includes(e.value) ? t(`Ordered maps must not include duplicate keys: ${e.value}`) : n.push(e.value));
          return Object.assign(new eY(), s);
        },
        createNode: (e, t, s) => eY.from(e, t, s),
      };
      function eW({ value: e, source: t }, s) {
        return t && (e ? eH : eQ).test.test(t) ? t : e ? s.options.trueStr : s.options.falseStr;
      }
      let eH = {
          identify: (e) => !0 === e,
          default: !0,
      ...
      function ez(e, t, s, { intAsBigInt: n }) {
        let i = e[0];
      ...
      class e0 extends ew {
        ...
        add(e) {
          ...
          ((t = p(e)
            ...
            : e && 'object' == typeof e && 'key' in e && 'value' in e && null === e.value
              ? new ey(e.key, null)
              : new ey(e, null)),
            ek(this.items, t.key) || this.items.push(t));
        }
        get(e, t) {
          let s = ek(this.items, e);
          return !t && p(s) ? (m(s.key) ? s.key.value : s.key) : s;
        }
        set(e, t) {
          if ('boolean' != typeof t)
            throw Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);
          let s = ek(this.items, e);
          s && !t ? this.items.splice(this.items.indexOf(s), 1) : !s && t && this.items.push(new ey(e));
        }
        toJSON(e, t) {
        ...
        static from(e, t, s) {
          let { replacer: n } = s,
            i = new this(e);
          if (t && Symbol.iterator in Object(t))
            for (let e of t) ('function' == typeof n && (e = n.call(t, e, e)), i.items.push(em(e, null, s)));
          return i;
        }
      }
      e0.tag = 'tag:yaml.org,2002:set';
      let e1 = {
        collection: 'map',
        ...
        createNode: (e, t, s) => e0.from(e, t, s),
        resolve(e, t) {
          if (d(e))
            if (e.hasAllNullValues(!0)) return Object.assign(new e0(), e);
      ...
      function e9(e) {
        ...
        return (
          t < 60
            ? r.unshift(0)
            : ((t = (t - r[0]) / i), r.unshift(t % i), t >= 60 && ((t = (t - r[0]) / i), r.unshift(t))),
          n +
            r
      ...
      let e8 = {
          ...
          resolve: (e, t, { intAsBigInt: s }) => e2(e, s),
          stringify: e9,
        },
        e3 = {
          identify: (e) => 'number' == typeof e,
        ...
        e4 = {
          ...
          resolve(e) {
            ...
            let [, s, n, i, r, o, l] = t.map(Number),
              a = Date.UTC(s, n - 1, i, r || 0, o || 0, l || 0, t[7] ? Number((t[7] + '00').substr(1, 3)) : 0),
              c = t[8];
            if (c && 'Z' !== c) {
              let e = e2(c, !1);
        ...
        e6 = [
          ...
          },
          {
            ...
            test: /^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,
            resolve(e) {
              let t = new U(parseFloat(e.replace(/_/g, ''))),
                s = e.indexOf('.');
              if (-1 !== s) {
        ...
        te = {
          'tag:yaml.org,2002:binary': eR,
          'tag:yaml.org,2002:merge': eu,
          'tag:yaml.org,2002:omap': eG,
          'tag:yaml.org,2002:pairs': eJ,
          'tag:yaml.org,2002:set': e1,
          'tag:yaml.org,2002:timestamp': e4,
        };
      function tt(e, t, s) {
        let n = e7.get(t);
        if (n && !e) return s && !n.includes(eu) ? n.concat(eu) : n.slice();
        let i = n;
        if (!i)
        ...
        return (
          ...
          i.reduce((e, t) => {
            ...
            return (e.includes(s) || e.push(s), e);
          }, [])
        );
      }
      let ts = (e, t) => (e.key < t.key ? -1 : +(e.key > t.key));
      class tn {
        constructor({
          compat: e,
          customTags: t,
          ...
          ((this.compat = Array.isArray(e) ? tt(e, 'compat') : e ? tt(null, e) : null),
            (this.name = ('string' == typeof i && i) || 'core'),
            (this.knownTags = n ? te : {}),
            (this.tags = tt(t, this.name, s)),
            (this.toStringOptions = l ?? null),
            Object.defineProperty(this, o, { value: ev }),
            Object.defineProperty(this, a, { value: eO }),
            Object.defineProperty(this, c, { value: eN }),
            (this.sortMapEntries = 'function' == typeof r ? r : !0 === r ? ts : null));
        }
        clone() {
      ...
      class ti {
        constructor(e, t, s) {
          ((this.commentBefore = null),
            ...
            (this.errors = []),
            (this.warnings = []),
            Object.defineProperty(this, u, { value: r }));
          let n = null;
          'function' == typeof t || Array.isArray(t) ? (n = t) : void 0 === s && t && ((s = t), (t = void 0));
          let i = Object.assign(
            {
              intAsBigInt: !1,
              keepSourceTokens: !1,
        ...
        clone() {
          let e = Object.create(ti.prototype, { [u]: { value: r } });
          return (
        ...
        add(e) {
          tr(this.contents) && this.contents.add(e);
        }
        addIn(e, t) {
          tr(this.contents) && this.contents.addIn(e, t);
        }
        createAlias(e, t) {
          if (!e.anchor) {
            let s = B(this);
            e.anchor = !t || s.has(t) ? K(t || 'a', s) : t;
          }
          return new P(e.anchor);
        }
        createNode(e, t, s) {
          let n;
          ...
          let { aliasDuplicateObjects: i, anchorPrefix: r, flow: o, keepUndefined: l, onTagObj: a, tag: c } = s ?? {},
            {
              onAnchor: u,
              setAnchors: h,
              sourceObjects: f,
              ...
              return {
                ...
                setAnchors: () => {
                  for (let e of s) {
                    let t = n.get(e);
                    if ('object' == typeof t && t.anchor && (m(t.node) || g(t.node))) t.node.anchor = t.anchor;
                    else {
            ...
            p = R(e, c, d);
          return (o && g(p) && (p.flow = !0), h(), p);
        }
        createPair(e, t, s = {}) {
          return new ey(this.createNode(e, null, s), this.createNode(t, null, s));
        }
        delete(e) {
          return !!tr(this.contents) && this.contents.delete(e);
        }
        deleteIn(e) {
          return V(e)
            ? null != this.contents && ((this.contents = null), !0)
            : !!tr(this.contents) && this.contents.deleteIn(e);
        }
        get(e, t) {
        ...
        has(e) {
          return !!g(this.contents) && this.contents.has(e);
        }
        hasIn(e) {
          return V(e) ? void 0 !== this.contents : !!g(this.contents) && this.contents.hasIn(e);
        }
        set(e, t) {
          null == this.contents
            ? (this.contents = F(this.schema, [e], t))
            : tr(this.contents) && this.contents.set(e, t);
        }
        setIn(e, t) {
          V(e)
            ? (this.contents = t)
            : null == this.contents
              ? (this.contents = F(this.schema, Array.from(e), t))
              : tr(this.contents) && this.contents.setIn(e, t);
        }
        setSchema(e, t = {}) {
          let s;
          switch (('number' == typeof e && (e = String(e)), e)) {
            ...
            case '1.2':
            case 'next':
              (this.directives ? (this.directives.yaml.version = e) : (this.directives = new C({ version: e })),
          ...
          else if (s) this.schema = new tn(Object.assign(s, t));
          else throw Error('With a null YAML version, the { schema: Schema } option is required');
        }
        toJS({ json: e, jsonArg: t, mapAsMap: s, maxAliasCount: n, onAnchor: i, reviver: r } = {}) {
          let o = {
              anchors: new Map(),
              doc: this,
              keep: !e,
          ...
          return 'function' == typeof r ? M(r, { '': l }, '', l) : l;
        }
        toJSON(e, t) {
            ...
            if (e.contents) {
              ...
              (l && (a += W(a, '', r(l))),
                ('|' === a[0] || '>' === a[0]) && '---' === s[s.length - 1]
                  ? (s[s.length - 1] = `--- ${a}`)
                  : s.push(a));
            } else s.push(ea(e.contents, i));
            if (e.directives?.docEnd)
              if (e.comment) {
                let t = r(e.comment);
                t.includes('\n') ? (s.push('...'), s.push(G(t, ''))) : s.push(`... ${t}`);
              } else s.push('...');
            else {
              let t = e.comment;
              (t && o && (t = t.replace(/^\n+/, '')),
                t && ((!o || l) && '' !== s[s.length - 1] && s.push(''), s.push(G(r(t), ''))));
            }
            return s.join('\n') + '\n';
          })(this, e);
        }
      ...
      let tc = (e, t) => (s) => {
        ...
        let r = i - 1,
          o = e.substring(t.lineStarts[n - 1], t.lineStarts[n]).replace(/[\n\r]+$/, '');
        if (r >= 60 && o.length > 80) {
        ...
        if (/[^ ]/.test(o)) {
          let e = 1,
            t = s.linePos[1];
          t && t.line === n && t.col > i && (e = Math.max(1, Math.min(t.col - i, 80 - r)));
...
`;
      ...
      function tu(e, { flow: t, indicator: s, next: n, offset: i, onError: r, parentIndent: o, startOnNewline: l }) {
        let a = !1,
          c = l,
          u = l,
          h = '',
          ...
          switch (
            (p &&
              ('space' !== i.type &&
                'newline' !== i.type &&
                'comma' !== i.type &&
                r(i.offset, 'MISSING_CHAR', 'Tags and anchors must be separated from the next token by white space'),
              (p = !1)),
            m &&
              (c &&
                'comment' !== i.type &&
                'newline' !== i.type &&
                r(m, 'TAB_AS_INDENT', 'Tabs are not allowed as indentation'),
              (m = null)),
            i.type)
          ) {
            case 'space':
              (!t && ('doc-start' !== s || n?.type !== 'flow-collection') && i.source.includes('	') && (m = i),
                (u = !0));
              break;
            case 'comment': {
              u || r(i, 'MISSING_CHAR', 'Comments must be separated from other tokens by white space characters');
              let e = i.source.substring(1) || ' ';
              (h ? (h += f + e) : (h = e), (f = ''), (c = !1));
              break;
            }
            case 'newline':
              (c ? (h ? (h += i.source) : (w && 'seq-item-ind' === s) || (a = !0)) : (f += i.source),
                (c = !0),
                (d = !0),
                (y || g) && (b = i),
                (u = !0));
              break;
            case 'anchor':
              (y && r(i, 'MULTIPLE_ANCHORS', 'A node can have at most one anchor'),
                i.source.endsWith(':') &&
                  r(i.offset + i.source.length - 1, 'BAD_ALIAS', 'Anchor ending in : is ambiguous', !0),
                (y = i),
                v ?? (v = i.offset),
                (c = !1),
                (u = !1),
              ...
              break;
            case 'tag':
              (g && r(i, 'MULTIPLE_TAGS', 'A node can have at most one tag'),
                (g = i),
                v ?? (v = i.offset),
                (c = !1),
                (u = !1),
              ...
              break;
            case s:
              ((y || g) && r(i, 'BAD_PROP_ORDER', `Anchors and tags must be after the ${i.source} indicator`),
                w && r(i, 'UNEXPECTED_TOKEN', `Unexpected ${i.source} in ${t ?? 'collection'}`),
                (w = i),
                (c = 'seq-item-ind' === s || 'explicit-key-ind' === s),
                (u = !1));
              break;
            case 'comma':
              if (t) {
                (k && r(i, 'UNEXPECTED_TOKEN', `Unexpected , in ${t}`), (k = i), (c = !1), (u = !1));
                break;
              }
            default:
              (r(i, 'UNEXPECTED_TOKEN', `Unexpected ${i.type} token`), (c = !1), (u = !1));
          }
        let S = e[e.length - 1],
        ...
        return (
          ...
          m &&
            ((c && m.indent <= o) || n?.type === 'block-map' || n?.type === 'block-seq') &&
            r(m, 'TAB_AS_INDENT', 'Tabs are not allowed as indentation'),
          {
            comma: k,
            found: w,
      ...
      function tf(e, t, s) {
        if (t?.type === 'flow-collection') {
          ...
          n.indent === e &&
            (']' === n.source || '}' === n.source) &&
            th(t) &&
            s(n, 'BAD_INDENT', 'Flow end indicator should be more indented than parent', !0);
        }
      }
      function td(e, t, s) {
        let { uniqueKeys: n } = e.options;
        if (!1 === n) return !1;
        let i = 'function' == typeof n ? n : (e, t) => e === t || (m(e) && m(t) && e.value === t.value);
        return t.some((e) => i(e.key, s));
      }
      let tp = 'All mapping items must start at the same column';
      function tm(e, t, s, n) {
        let i = '';
        if (e) {
          let r = !1,
          ...
          for (let l of e) {
            ...
            switch (a) {
              ...
              case 'comment': {
                s &&
                  !r &&
                  n(l, 'MISSING_CHAR', 'Comments must be separated from other tokens by white space characters');
                let t = e.substring(1) || ' ';
                (i ? (i += o + t) : (i = t), (o = ''));
                break;
              }
      ...
      let ty = 'Block collections are not allowed within flow collections',
        tg = (e) => e && ('block-map' === e.type || 'block-seq' === e.type);
      function tb(e, t, s, n, i, r) {
        let o =
            'block-map' === s.type
              ? (function ({ composeNode: e, composeEmptyNode: t }, s, n, i, r) {
                  let o = new (r?.nodeClass ?? ew)(s.schema);
                  s.atRoot && (s.atRoot = !1);
                  let l = n.offset,
                    a = null;
                  for (let r of n.items) {
                    let { start: c, key: u, sep: h, value: f } = r,
                      d = tu(c, {
                      ...
                      if (
                        (u &&
                          ('block-seq' === u.type
                            ...
                            : 'indent' in u && u.indent !== n.indent && i(l, 'BAD_INDENT', tp)),
                        !d.anchor && !d.tag && !h)
                      ) {
                        ((a = d.end),
                          d.comment && (o.comment ? (o.comment += '\n' + d.comment) : (o.comment = d.comment)));
                        continue;
                      }
                      (d.newlineAfterProp || th(u)) &&
                        i(u ?? c[c.length - 1], 'MULTILINE_IMPLICIT_KEY', 'Implicit keys need to be on a single line');
                    } else d.found?.indent !== n.indent && i(l, 'BAD_INDENT', tp);
                    s.atKey = !0;
                    let m = d.end,
                      y = u ? e(s, u, d, i) : t(s, m, c, null, d, i);
                    (s.schema.compat && tf(n.indent, u, i),
                      (s.atKey = !1),
                      td(s, o.items, y) && i(m, 'DUPLICATE_KEY', 'Map keys must be unique'));
                    let g = tu(h ?? [], {
                    ...
                    if (((l = g.end), g.found)) {
                      ...
                      let a = f ? e(s, f, g, i) : t(s, l, h, null, g, i);
                      (s.schema.compat && tf(n.indent, f, i), (l = a.range[2]));
                      let c = new ey(y, a);
                      (s.options.keepSourceTokens && (c.srcToken = r), o.items.push(c));
                    } else {
                      ...
                      let e = new ey(y);
                      (s.options.keepSourceTokens && (e.srcToken = r), o.items.push(e));
                    }
                  }
                  return (
                    a && a < l && i(a, 'IMPOSSIBLE', 'Map comment with trailing content'),
                    (o.range = [n.offset, l, a ?? l]),
                    o
                  );
                })(e, t, s, n, r)
              : 'block-seq' === s.type
                ? (function ({ composeNode: e, composeEmptyNode: t }, s, n, i, r) {
                    let o = new (r?.nodeClass ?? eS)(s.schema);
                    (s.atRoot && (s.atRoot = !1), s.atKey && (s.atKey = !1));
                    let l = n.offset,
                      a = null;
                    for (let { start: r, value: c } of n.items) {
                      let u = tu(r, {
                      ...
                      if (!u.found)
                        if (u.anchor || u.tag || c)
                          ...
                          ((a = u.end), u.comment && (o.comment = u.comment));
                          continue;
                        }
                      let h = c ? e(s, c, u, i) : t(s, u.end, r, null, u, i);
                      (s.schema.compat && tf(n.indent, c, i), (l = h.range[2]), o.items.push(h));
                    }
                    return ((o.range = [n.offset, l, a ?? l]), o);
                  })(e, t, s, n, r)
                : (function ({ composeNode: e, composeEmptyNode: t }, s, n, i, r) {
                    let o = '{' === n.start.source,
                      l = o ? 'flow map' : 'flow sequence',
                      a = new (r?.nodeClass ?? (o ? ew : eS))(s.schema);
                    a.flow = !0;
                    let c = s.atRoot;
                    ...
                    for (let r = 0; r < n.items.length; ++r) {
                      ...
                      if (!y.found) {
                        if (!y.anchor && !y.tag && !d && !m) {
                          (0 === r && y.comma
                            ? i(y.comma, 'UNEXPECTED_TOKEN', `Unexpected , in ${l}`)
                            : r < n.items.length - 1 && i(y.start, 'UNEXPECTED_TOKEN', `Unexpected empty item in ${l}`),
                            y.comment && (a.comment ? (a.comment += '\n' + y.comment) : (a.comment = y.comment)),
                            (u = y.end));
                          continue;
                        }
                        !o &&
                      ...
                      if (0 === r) y.comma && i(y.comma, 'UNEXPECTED_TOKEN', `Unexpected , in ${l}`);
                      ...
                      if (o || d || y.found) {
                        s.atKey = !0;
                        let r = y.end,
                          p = f ? e(s, f, y, i) : t(s, r, h, null, y, i);
                        (tg(f) && i(p.range, 'BLOCK_IN_FLOW', ty), (s.atKey = !1));
                        let g = tu(d ?? [], {
                          flow: l,
                          indicator: 'map-value-ind',
                          next: m,
                        ...
                        if (g.found) {
                          ...
                          m &&
                            ('source' in m && m.source && ':' === m.source[0]
                              ? i(m, 'MISSING_CHAR', `Missing space after : in ${l}`)
                              : i(g.start, 'MISSING_CHAR', `Missing , or : between ${l} items`));
                        let b = m ? e(s, m, g, i) : g.found ? t(s, g.end, d, null, g, i) : null;
                        b
                          ? tg(m) && i(b.range, 'BLOCK_IN_FLOW', ty)
                          : g.comment && (p.comment ? (p.comment += '\n' + g.comment) : (p.comment = g.comment));
                        let k = new ey(p, b);
                        if ((s.options.keepSourceTokens && (k.srcToken = c), o))
                          (td(s, a.items, p) && i(r, 'DUPLICATE_KEY', 'Map keys must be unique'), a.items.push(k));
                        else {
                          let e = new ew(s.schema);
                          ((e.flow = !0), e.items.push(k));
                          let t = (b ?? p).range;
                          ((e.range = [p.range[0], t[1], t[2]]), a.items.push(e));
                        }
                        u = b ? b.range[2] : g.end;
                      } else {
                        let n = m ? e(s, m, y, i) : t(s, y.end, d, null, y, i);
                        (a.items.push(n), (u = n.range[2]), tg(m) && i(n.range, 'BLOCK_IN_FLOW', ty));
                      }
                    }
                    let h = o ? '}' : ']',
                      [f, ...d] = n.end,
                      m = u;
                    if (f && f.source === h) m = f.offset + f.source.length;
                    else {
                      let e = l[0].toUpperCase() + l.substring(1),
                        t = c
                          ? `${e} must end with a ${h}`
                          : `${e} in block collection must be sufficiently indented and end with a ${h}`;
                      (i(u, c ? 'MISSING_CHAR' : 'BAD_INDENT', t), f && 1 !== f.source.length && d.unshift(f));
                    }
                    if (d.length > 0) {
                      let e = tm(d, m, s.options.strict, i);
                      (e.comment && (a.comment ? (a.comment += '\n' + e.comment) : (a.comment = e.comment)),
                        (a.range = [n.offset, m, e.offset]));
                    } else a.range = [n.offset, m, m];
                    return a;
                  })(e, t, s, n, r),
          l = o.constructor;
            ...
            ? (function (e, t, s) {
                let n = t.offset,
                  i = (function ({ offset: e, props: t }, s, n) {
                    ...
                    -1 !== a && n(a, 'UNEXPECTED_TOKEN', `Block scalar header includes extra characters: ${i}`);
                    let c = !1,
                      u = '',
                      h = i.length;
                    for (let e = 1; e < t.length; ++e) {
                      ...
                      switch (i.type) {
                        ...
                        case 'comment':
                          ...
                          break;
                        case 'error':
                          (n(i, 'UNEXPECTED_TOKEN', i.message), (h += i.source.length));
                          break;
                        default: {
                    ...
                    return { mode: r, indent: o, chomp: l, comment: u, length: h };
                  })(t, e.options.strict, s);
                if (!i) return { value: '', type: null, comment: '', range: [n, n, n] };
                let r = '>' === i.mode ? U.BLOCK_FOLDED : U.BLOCK_LITERAL,
                  o = t.source
                    ? (function (e) {
                        let t = e.split(/\n( *)/),
                          s = t[0],
                ...
                if (0 === l) {
                  let e = '+' === i.chomp && o.length > 0 ? '\n'.repeat(Math.max(1, o.length - 1)) : '',
                    s = n + i.length;
                  return (
                    t.source && (s += t.source.length),
                    { value: e, type: r, comment: i.comment, range: [n, s, s] }
                  );
                }
                ...
                for (let t = 0; t < l; ++t) {
                  let [n, r] = o[t];
                  if ('' === r || '\r' === r) 0 === i.indent && n.length > a && (a = n.length);
                  else {
                    (n.length < a &&
                      s(
                        c + n.length,
                      ...
                      0 === i.indent && (a = n.length),
                      (u = t),
                      0 !== a || e.atRoot || s(c, 'BAD_INDENT', 'Block scalar values in collections must be indented'));
                    break;
                  }
                  c += n.length + r.length + 1;
                }
                for (let e = o.length - 1; e >= l; --e) o[e][0].length > a && (l = e + 1);
                let h = '',
                  f = '',
                  d = !1;
                for (let e = 0; e < u; ++e) h += o[e][0].slice(a) + '\n';
                for (let e = u; e < l; ++e) {
                  let [t, n] = o[e];
                ...
                switch (i.chomp) {
                  case '-':
                    break;
                  case '+':
                    for (let e = l; e < o.length; ++e) h += '\n' + o[e][0].slice(a);
                    '\n' !== h[h.length - 1] && (h += '\n');
                    break;
                  default:
                    h += '\n';
                }
                let p = n + i.length + t.source.length;
                return { value: h, type: r, comment: i.comment, range: [n, p, p] };
              })(e, t, n)
            : (function (e, t, s) {
                let n,
                  i,
                  { offset: r, type: o, source: l, end: a } = e,
                  c = (e, t, n) => s(r + e, t, n);
                switch (o) {
                  case 'scalar':
                    ((n = U.PLAIN),
                      (i = (function (e, t) {
                        ...
                        return (s && t(0, 'BAD_SCALAR_START', `Plain value cannot start with ${s}`), tk(e));
                      })(l, c)));
                    break;
                  case 'single-quoted-scalar':
                    var u, h;
                    ((n = U.QUOTE_SINGLE),
                      (u = l),
                      (h = c),
                      ("'" !== u[u.length - 1] || 1 === u.length) &&
                        h(u.length, 'MISSING_CHAR', "Missing closing 'quote"),
                      (i = tk(u.slice(1, -1)).replace(/''/g, "'")));
                    break;
                  case 'double-quoted-scalar':
                    ((n = U.QUOTE_DOUBLE),
                      (i = (function (e, t) {
                          ...
                          if ('\r' !== i || '\n' !== e[n + 1])
                            if ('\n' === i) {
                              ...
                              let i = e[++n],
                                r = tw[i];
                              if (r) s += r;
                              else if ('\n' === i) for (i = e[n + 1]; ' ' === i || '	' === i; ) i = e[++n + 1];
                              else if ('\r' === i && '\n' === e[n + 1])
                                for (i = e[++n + 1]; ' ' === i || '	' === i; ) i = e[++n + 1];
                              else if ('x' === i || 'u' === i || 'U' === i) {
                                let r = { x: 2, u: 4, U: 8 }[i];
                                ((s += (function (e, t, s, n) {
                                  let i = e.substr(t, s),
                                    r = i.length === s && /^[0-9a-fA-F]+$/.test(i) ? parseInt(i, 16) : NaN;
                                  if (isNaN(r)) {
                                    let i = e.substr(t - 2, s + 2);
                                    return (n(t - 2, 'BAD_DQ_ESCAPE', `Invalid escape sequence ${i}`), i);
                                  }
                                ...
                                (t(n - 1, 'BAD_DQ_ESCAPE', `Invalid escape sequence ${i}`), (s += i));
                              }
                            } else if (' ' === i || '	' === i) {
                              let t = n,
                                r = e[n + 1];
                              for (; ' ' === r || '	' === r; ) r = e[++n + 1];
                              '\n' !== r && ('\r' !== r || '\n' !== e[n + 2]) && (s += n > t ? e.slice(t, n + 1) : i);
                            } else s += i;
                        }
                        return (
                  ...
                  default:
                    return (
                      s(e, 'UNEXPECTED_TOKEN', `Expected a flow scalar value, but found: ${o}`),
                      { value: '', type: null, comment: '', range: [r, r + l.length, r + l.length] }
                    );
                }
                let f = r + l.length,
                  d = tm(a, f, t, s);
                return { value: i, type: n, comment: d.comment, range: [r, f, d.offset] };
              })(t, e.options.strict, n),
          h = s ? e.directives.tagName(s.source, (e) => n(s, 'TAG_RESOLVE_FAILED', e)) : null;
        i =
            ...
            : h
              ? (function (e, t, s, n, i) {
                  ...
                  return o && !o.collection
                    ...
                    : (i(n, 'TAG_RESOLVE_FAILED', `Unresolved tag: ${s}`, 'tag:yaml.org,2002:str' !== s), e[a]);
                })(e.schema, o, h, s, n)
              : 'scalar' === t.type
                ? (function ({ atKey: e, directives: t, schema: s }, n, i, r) {
                    let o =
                      s.tags.find((t) => (!0 === t.default || (e && 'key' === t.default)) && t.test?.test(n)) || s[a];
                    if (s.compat) {
                      let e = s.compat.find((e) => e.default && e.test?.test(n)) ?? s[a];
                      if (o.tag !== e.tag) {
                        let s = t.tagString(o.tag),
                          n = t.tagString(e.tag);
                        r(i, 'TAG_RESOLVE_FAILED', `Value may be parsed as either ${s} or ${n}`, !0);
                      }
                    }
                    return o;
                  })(e, o, t, n)
                : e.schema[a];
        try {
          let l = i.resolve(o, (e) => n(s ?? t, 'TAG_RESOLVE_FAILED', e), e.options);
          r = m(l) ? l : new U(l);
        } catch (e) {
          (n(s ?? t, 'TAG_RESOLVE_FAILED', e instanceof Error ? e.message : String(e)), (r = new U(o)));
        }
        return (
          (r.range = u),
          (r.source = o),
          l && (r.type = l),
          h && (r.tag = h),
          i.format && (r.format = i.format),
          c && (r.comment = c),
          r
        );
      }
      let tS = { composeNode: tE, composeEmptyNode: tN };
      function tE(e, t, s, n) {
        let i,
          r = e.atKey,
          { spaceBefore: o, comment: l, anchor: a, tag: c } = s,
          u = !0;
        switch (t.type) {
          case 'alias':
            ((i = (function ({ options: e }, { offset: t, source: s, end: n }, i) {
              let r = new P(s.substring(1));
              ('' === r.source && i(t, 'BAD_ALIAS', 'Alias cannot be an empty string'),
                r.source.endsWith(':') && i(t + s.length - 1, 'BAD_ALIAS', 'Alias ending in : is ambiguous', !0));
              let o = t + s.length,
                l = tm(n, o, e.strict, i);
              return ((r.range = [t, o, l.offset]), l.comment && (r.comment = l.comment), r);
            })(e, t, n)),
              (a || c) && n(t, 'ALIAS_PROPS', 'An alias node must not specify any properties'));
            break;
          case 'scalar':
          case 'single-quoted-scalar':
          case 'double-quoted-scalar':
          case 'block-scalar':
            ((i = tv(e, t, c, n)), a && (i.anchor = a.source.substring(1)));
            break;
          case 'block-map':
          case 'block-seq':
          case 'flow-collection':
            ((i = (function (e, t, s, n, i) {
              let r = n.tag,
                o = r ? t.directives.tagName(r.source, (e) => i(r, 'TAG_RESOLVE_FAILED', e)) : null;
              if ('block-seq' === s.type) {
                let { anchor: e, newlineAfterProp: t } = n,
                  s = e && r ? (e.offset > r.offset ? e : r) : (e ?? r);
                s && (!t || t.offset < s.offset) && i(s, 'MISSING_CHAR', 'Missing newline after block sequence props');
              }
              let l =
                'block-map' === s.type
                  ? 'map'
                  : 'block-seq' === s.type
                    ...
                    : '{' === s.start.source
                      ? 'map'
                      : 'seq';
              if (!r || !o || '!' === o || (o === ew.tagName && 'map' === l) || (o === eS.tagName && 'seq' === l))
                return tb(e, t, s, i, o);
              let a = t.schema.tags.find((e) => e.tag === o && e.collection === l);
              if (!a) {
                let n = t.schema.knownTags[o];
                if (!n || n.collection !== l)
                  return (
                    n
                      ? i(
                          r,
                          'BAD_COLLECTION_TYPE',
                          `${n.tag} used for ${l} collection, but expects ${n.collection ?? 'scalar'}`,
                          !0,
                        )
                      : i(r, 'TAG_RESOLVE_FAILED', `Unresolved tag: ${o}`, !0),
                    tb(e, t, s, i, o)
                  );
                (t.schema.tags.push(Object.assign({}, n, { default: !1 })), (a = n));
              }
              let c = tb(e, t, s, i, o, a),
                u = a.resolve?.(c, (e) => i(r, 'TAG_RESOLVE_FAILED', e), t.options) ?? c,
                h = b(u) ? u : new U(u);
              return ((h.range = c.range), (h.tag = o), a?.format && (h.format = a.format), h);
            })(tS, e, t, s, n)),
              a && (i.anchor = a.source.substring(1)));
            break;
          default: {
            let r = 'error' === t.type ? t.message : `Unsupported token (type: ${t.type})`;
            (n(t, 'UNEXPECTED_TOKEN', r), (i = tN(e, t.offset, void 0, null, s, n)), (u = !1));
          }
        }
        return (
          a && '' === i.anchor && n(a, 'BAD_ALIAS', 'Anchor cannot be an empty string'),
          r &&
            e.options.stringKeys &&
            (!m(i) || 'string' != typeof i.value || (i.tag && 'tag:yaml.org,2002:str' !== i.tag)) &&
            n(c ?? t, 'NON_STRING_KEY', 'With stringKeys, all keys must be strings'),
          o && (i.spaceBefore = !0),
          l && ('scalar' === t.type && '' === t.source ? (i.comment = l) : (i.commentBefore = l)),
          e.options.keepSourceTokens && u && (i.srcToken = t),
          i
        );
      }
      function tN(e, t, s, n, { spaceBefore: i, comment: r, anchor: o, tag: l, end: a }, c) {
        let u = tv(
          e,
          {
            type: 'scalar',
            offset: (function (e, t, s) {
              if (t) {
                ...
                for (let n = s - 1; n >= 0; --n) {
                  ...
                  for (s = t[++n]; s?.type === 'space'; ) ((e += s.source.length), (s = t[++n]));
                  break;
                }
              }
              return e;
        ...
        return (
          o &&
            ...
            '' === u.anchor && c(o, 'BAD_ALIAS', 'Anchor cannot be an empty string')),
          i && (u.spaceBefore = !0),
          r && ((u.comment = r), (u.range[2] = a)),
          u
        );
      }
      function tO(e) {
        ...
        constructor(e = {}) {
          ((this.doc = null),
            ...
            (this.onError = (e, t, s, n) => {
              let i = tO(e);
              n ? this.warnings.push(new ta(i, t, s)) : this.errors.push(new tl(i, t, s));
            }),
            (this.directives = new C({ version: e.version || '1.2' })),
            (this.options = e));
        }
        decorate(e, t) {
          let { comment: s, afterEmptyLine: n } = tA(this.prelude);
          if (s) {
            let i = e.contents;
            if (t)
              e.comment = e.comment
...
${s}`
            ...
            else if (g(i) && !i.flow && i.items.length > 0) {
              let e = i.items[0];
              p(e) && (e = e.key);
        ...
        *next(e) {
          switch (e.type) {
            case 'directive':
              ...
              break;
            case 'document': {
              let t = (function (e, t, { offset: s, start: n, value: i, end: r }, o) {
                let l = new ti(void 0, Object.assign({ _directives: t }, e)),
                  a = { atKey: !1, atRoot: !0, directives: l.directives, options: l.options, schema: l.schema },
                  c = tu(n, {
                    indicator: 'doc-start',
                    next: i ?? r?.[0],
                    offset: s,
                ...
                (c.found &&
                  ...
                  i &&
                    ...
                    !c.hasNewline &&
                    o(c.end, 'MISSING_CHAR', 'Block collection cannot start on same line with directives-end marker')),
                  (l.contents = i ? tE(a, i, c, o) : tN(a, c.end, n, null, c, o)));
                let u = l.contents.range[2],
                  h = tm(r, u, !1, o);
                return (h.comment && (l.comment = h.comment), (l.range = [s, u, h.offset]), l);
            ...
            case 'error': {
              let t = e.source ? `${e.message}: ${JSON.stringify(e.source)}` : e.message,
                s = new tl(tO(e), 'UNEXPECTED_TOKEN', t);
              this.atDirectives || !this.doc ? this.errors.push(s) : this.doc.errors.push(s);
              break;
            }
            case 'doc-end': {
              if (!this.doc) {
                this.errors.push(new tl(tO(e), 'UNEXPECTED_TOKEN', 'Unexpected doc-end without preceding document'));
                break;
              }
              this.doc.directives.docEnd = !0;
              let t = tm(e.end, e.offset + e.source.length, this.doc.options.strict, this.onError);
...
${t.comment}`
            ...
            default:
              this.errors.push(new tl(tO(e), 'UNEXPECTED_TOKEN', `Unsupported token ${e.type}`));
          }
        }
        *end(e = !1, t = -1) {
      ...
      let tT = Symbol('break visit'),
        tx = Symbol('skip children'),
        t$ = Symbol('remove item');
      function tL(e, t) {
      ...
      ((tL.BREAK = tT),
        ...
        (tL.parentCollection = (e, t) => {
          let s = tL.itemAtPath(e, t.slice(0, -1)),
            n = t[t.length - 1][0],
            i = s?.[n];
          if (i && 'items' in i) return i;
          throw Error('Parent collection not found');
        }));
      let t_ = new Set('0123456789ABCDEFabcdef'),
        tB = new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),
        tK = new Set(',[]{}'),
        tM = new Set(' ,[]{}\n\r	'),
        tj = (e) => !e || tM.has(e);
      class tD {
        ...
        *lex(e, t = !1) {
        ...
        continueScalar(e) {
          ...
          if (this.indentNext > 0) {
            ...
            return '\n' !== t && !(s >= this.indentNext) && (t || this.atEnd) ? -1 : e + s;
          }
          if ('-' === t || '.' === t) {
            let t = this.buffer.substr(e, 3);
            if (('---' === t || '...' === t) && tC(this.buffer[e + 3])) return -1;
          }
          return e;
        }
        getLine() {
        ...
        *parseStream() {
          ...
          return (yield '\x02', yield* this.parseLineStart());
        }
        *parseLineStart() {
          let e = this.charAt(0);
          ...
          return (
            ...
            this.indentNext > this.indentValue && !tC(this.charAt(1)) && (this.indentNext = this.indentValue),
        ...
        *parseDocument() {
          ...
          switch (e[t]) {
            ...
            case '*':
              return (yield* this.pushUntil(tj), 'doc');
            case '"':
            case "'":
              return yield* this.parseQuotedScalar();
            case '|':
        ...
        *parseFlowCollection() {
          ...
          if (
            ((-1 !== s && s < this.indentNext && '#' !== n[0]) ||
              (0 === s && (n.startsWith('---') || n.startsWith('...')) && tC(n[3]))) &&
            (s !== this.indentNext - 1 || 1 !== this.flowLevel || (']' !== n[0] && '}' !== n[0]))
          )
            return ((this.flowLevel = 0), yield '\x18', yield* this.parseLineStart());
          let i = 0;
          for (; ',' === n[i]; )
          ...
          switch (n[(i += yield* this.pushIndicators())]) {
            ...
            case '*':
              return (yield* this.pushUntil(tj), 'flow');
            case '"':
            case "'":
              return ((this.flowKey = !0), yield* this.parseQuotedScalar());
            case ':': {
              let e = this.charAt(1);
              if (this.flowKey || tC(e) || ',' === e)
        ...
        *parseBlockScalarHeader() {
          ...
          return yield* this.pushUntil((e) => tC(e) || '#' === e);
        }
        *parseBlockScalar() {
          let e,
            t = this.pos - 1,
          ...
          let n = t + 1;
          for (e = this.buffer[n]; ' ' === e; ) e = this.buffer[++n];
          if ('	' === e) {
            for (; '	' === e || ' ' === e || '\r' === e || '\n' === e; ) e = this.buffer[++n];
            t = n - 1;
            ...
            for (;;) {
              ...
              '\r' === n && (n = this.buffer[--e]);
              let i = e;
              for (; ' ' === n; ) n = this.buffer[--e];
              if ('\n' === n && e >= this.pos && e + 1 + s > i) t = e;
              else break;
            }
          return (yield '\x1f', yield* this.pushToIndex(t + 1, !0), yield* this.parseLineStart());
        }
        *parsePlainScalar() {
          let e,
            t = this.flowLevel > 0,
          ...
          for (; (e = this.buffer[++n]); )
            if (':' === e) {
              let e = this.buffer[n + 1];
              if (tC(e) || (t && tK.has(e))) break;
              s = n;
            } else if (tC(e)) {
              let i = this.buffer[n + 1];
              if (
                ('\r' === e && ('\n' === i ? ((n += 1), (e = '\n'), (i = this.buffer[n + 1])) : (s = n)),
                '#' === i || (t && tK.has(i)))
              )
                break;
              if ('\n' === e) {
          ...
          return e || this.atEnd
            ? (yield '\x1f', yield* this.pushToIndex(s + 1, !0), t ? 'flow' : 'doc')
        ...
        *pushIndicators() {
          switch (this.charAt(0)) {
            ...
            case '&':
              return (yield* this.pushUntil(tj)) + (yield* this.pushSpaces(!0)) + (yield* this.pushIndicators());
            case '-':
            case '?':
            case ':': {
        ...
        *pushTag() {
          ...
          }
          {
            let e = this.pos + 1,
              t = this.buffer[e];
            for (; t; )
              if (tB.has(t)) t = this.buffer[++e];
              else if ('%' === t && t_.has(this.buffer[e + 1]) && t_.has(this.buffer[e + 2])) t = this.buffer[(e += 3)];
              else break;
        ...
        *pushSpaces(e) {
          ...
          while (' ' === t || (e && '	' === t));
          let n = s - this.pos;
          return (n > 0 && (yield this.buffer.substr(this.pos, n), (this.pos = s)), n);
        }
        *pushUntil(e) {
          let t = this.pos,
            s = this.buffer[t];
      ...
      function tV(e) {
        if ('flow-seq-start' === e.start.type)
          for (let t of e.items)
            !t.sep ||
              t.value ||
              tP(t.start, 'explicit-key-ind') ||
              tP(t.sep, 'map-value-ind') ||
              (t.key && (t.value = t.key),
              delete t.key,
              tU(t.value)
                ? t.value.end
      ...
      class tJ {
        ...
        *parse(e, t = !1) {
          for (let s of (this.onNewLine && 0 === this.offset && this.onNewLine(0), this.lexer.lex(e, t)))
            yield* this.next(s);
          t || (yield* this.end());
        }
        *next(e) {
          ...
          if (t)
            if (0 === this.stack.length) yield t;
              ...
              switch (
                ...
                case 'block-seq': {
                  let s = e.items[e.items.length - 1];
                  s.value ? e.items.push({ start: [], value: t }) : (s.value = t);
                  break;
                }
                case 'flow-collection': {
                  let s = e.items[e.items.length - 1];
              ...
              if (
                ...
                s &&
                  ...
                  s.start.length > 0 &&
                  -1 === tq(s.start) &&
                  (0 === t.indent || s.start.every((e) => 'comment' !== e.type || e.indent < t.indent)) &&
                  ('document' === e.type ? (e.end = s.start) : e.items.push({ start: s.start }), t.items.splice(-1, 1));
              }
            }
        ...
        *stream() {
          switch (this.type) {
            ...
            case 'doc-start': {
              ...
              ('doc-start' === this.type && e.start.push(this.sourceToken), this.stack.push(e));
              return;
            }
          }
          yield {
        ...
        *document(e) {
          ...
          switch (this.type) {
            case 'doc-start':
              -1 !== tq(e.start) ? (yield* this.pop(), yield* this.step()) : e.start.push(this.sourceToken);
              return;
            case 'anchor':
            case 'tag':
            case 'space':
        ...
        *scalar(e) {
          if ('map-value-ind' === this.type) {
            ...
            let n = { type: 'block-map', offset: e.offset, indent: e.indent, items: [{ start: s, key: e, sep: t }] };
        ...
        *blockMap(e) {
          ...
          switch (this.type) {
            case 'newline':
              if (((this.onKeyLine = !1), t.value)) {
                ...
                n?.type === 'comment' ? s?.push(this.sourceToken) : e.items.push({ start: [this.sourceToken] });
          ...
          if (this.indent >= e.indent) {
            let s = !this.onKeyLine && this.indent === e.indent,
              n = s && (t.sep || t.explicitKey) && 'seq-item-ind' !== this.type,
              i = [];
            if (n && t.sep && !t.value) {
              let s = [];
            ...
            switch (this.type) {
              ...
              case 'map-value-ind':
                if (t.explicitKey)
                  if (t.sep)
                    ...
                    else if (tP(t.sep, 'map-value-ind'))
                      this.stack.push({
                        type: 'block-map',
                        offset: this.offset,
                        indent: this.indent,
                    ...
                    else if (tU(t.key) && !tP(t.sep, 'newline')) {
                      let e = tF(t.start),
                        s = t.key,
                        n = t.sep;
                  ...
                  else if (tP(t.start, 'newline')) Object.assign(t, { key: null, sep: [this.sourceToken] });
                  else {
                    let e = tF(t.start);
                    this.stack.push({
                      type: 'block-map',
              ...
              case 'double-quoted-scalar': {
                ...
                n || t.value
                  ? (e.items.push({ start: i, key: s, sep: [] }), (this.onKeyLine = !0))
                  : t.sep
                    ? this.stack.push(s)
                    : (Object.assign(t, { key: s, sep: [] }), (this.onKeyLine = !0));
                return;
              }
              default: {
                ...
                if (n) {
                  if ('block-seq' === n.type) {
                    if (!t.explicitKey && t.sep && !tP(t.sep, 'newline'))
        ...
        *blockSequence(e) {
          ...
          switch (this.type) {
            ...
            case 'seq-item-ind':
              ...
              t.value || tP(t.start, 'seq-item-ind')
          ...
          if ('flow-error-end' === this.type) {
            ...
            if (
              ...
              if ('map-value-ind' === this.type && 'flow-collection' !== t.type) {
                let s = tF(tR(t));
                tV(e);
                let n = e.end.splice(1, e.end.length);
                n.push(this.sourceToken);
                let i = {
                  type: 'block-map',
                  offset: e.offset,
      ...
      function tG(e, t, s) {
        let n;
        'function' == typeof t ? (n = t) : void 0 === s && t && 'object' == typeof t && (s = t);
        let i = (function (e, t = {}) {
          let { lineCounter: s, prettyErrors: n } = (function (e) {
              let t = !1 !== e.prettyErrors;
              return { lineCounter: e.lineCounter || (t && new tY()) || null, prettyErrors: t };
            })(t),
            i = new tJ(s?.addNewLine),
            r = new tI(t),
            o = null;
          ...
          return (n && s && (o.errors.forEach(tc(e, s)), o.warnings.forEach(tc(e, s))), o);
        })(e, s);
        if (!i) return null;
        if ((i.warnings.forEach((e) => ec(i.options.logLevel, e)), i.errors.length > 0))
      ...
      function tW(e, t, s) {
        let n = null;
        if (
          ('function' == typeof t || Array.isArray(t) ? (n = t) : void 0 === s && t && (s = t),
        ...
        return f(e) && !n ? e.toString(s) : new ti(e, n, s).toString(s);
      }
    },
  },
]);
