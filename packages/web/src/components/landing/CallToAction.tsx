...
type CallToActionProps = { title: string; subtitle: string; action: string; href: string };

export const CallToAction: FC<CallToActionProps> = ({ title = '', subtitle = '', action = '', href = '' }) => {
  return (
