...
export const GitHubSocialPreview: FC<{ name: string; description: string; repository: string }> = ({
  name = '',
  description = '',
  repository = '',
}) => {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center overflow-hidden rounded-2xl border border-neutral-800">
      <div className="h-[640px] w-[1280px]">
        <div ref={divRef} className="flex h-full w-full items-center justify-center bg-neutral-900">
