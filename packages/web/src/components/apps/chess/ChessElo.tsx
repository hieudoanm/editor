import { calculate, Score, TimeClass } from '@editor/utils/chess/elo';
import { ChangeEvent, useState } from 'react';

export const ChessElo = () => {
  ...
  return (
    <div className="flex w-full max-w-md flex-col rounded-xl border border-neutral-800 shadow">
      <div className="divide-y divide-neutral-800">
        <div className="flex w-full items-center gap-x-2 px-4 py-2">
        ...
        <div className="p-4">
          <button
            type="button"
            className="w-full cursor-pointer rounded bg-neutral-900 py-2 font-semibold text-neutral-100"
            onClick={() => {
